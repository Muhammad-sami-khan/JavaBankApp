...
public class Bank {
    ...
    // This method is used to retrieve and display the balance of a specific account from the database.
   ...
   /*This method is used to withdraw a specified amount from a specific account.
    ...
    //This method is used to deposit a specified amount into a specific account in the database.
    ...
    // This method retrieves and displays the transaction history of a specific account from the database.
    ...
    //This method records a transaction (deposit, withdrawal, or transfer) for a specific account in the database.
    public void recordTransaction(Connection conn, int accNum, String type, double amount) throws SQLException {
        ...
        /* This method transfers a specified amount of money from a sender's account to a recipient's account.
           It checks if the sender's account has sufficient balance before making the transfer. */
